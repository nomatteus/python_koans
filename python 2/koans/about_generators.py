...
class AboutGenerators(Koan):
    ...
    def test_generators_are_different_to_list_comprehensions(self):
        ...
        # BAD WAY TO MAKE IT WORK: with self.assertRaises(TypeError): num = num_generator[0]
    ...
    def test_generators_can_take_coroutines(self):
        ...
        # The generator needs to be initialized so that the first call
        #   will be pointing to something
        #
